      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Building Reliable Backend Systems &amp; APIs
            {/* Hand-drawn arrow */}
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Backend developer with 2 years at Bharat Clouds Pvt. Ltd. 
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="Backend Development [2024 - 2026]"
            text="Building REST APIs, authentication, and server-side logic with Node.js and Express.js for reliable, scalable applications."
          ...
          <TagCard
            ...
            text="Designing schemas and writing efficient queries with MySQL and MongoDB to power dynamic, data-driven applications."
          ...
          <TagCard
            ...
            text="Crafting responsive interfaces with React, JavaScript, HTML5, CSS3, and Bootstrap for full-stack projects." className="md:absolute md:top-[700px] md:right-[5%] lg:right-[15%] rotate-1 md:rotate-3"
            aosType="fade-left"
            aosDelay="300"
            pathLength={pathLength}
            containerRef={containerRef}
          ...
          <TagCard
            ...
            text="Combining frontend and backend to build and deploy complete web applications from end to end."
