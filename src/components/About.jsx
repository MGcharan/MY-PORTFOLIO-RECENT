      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <p className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-red-50">
            Hi, my name is <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">Giricharan</span>, a Backend Developer at <span className="text-black font-black">Bharat Clouds Pvt. Ltd.</span> I build scalable server-side applications and REST APIs with Node.js and MySQL. I started out building full-stack projects with React, and today I focus on the backend — designing databases, writing efficient queries, and shipping reliable services.
          </p>
